...
``` 
   ...
   <div align="center">
      <img src="https://i.postimg.cc/hGF4HTVx/AC10-1-1.png" alt="AC10.1" width="950" />
   </div>
...
La opción -v activa el modo detallado, mostrándote qué pruebas se ejecutaron y sus resultados. Si las pruebas pasan, verás una salida con texto en verde. Si alguna prueba falla, el texto será rojo.
   ...
   <div align="center">
      <img src="https://i.postimg.cc/L8g6CNg2/AC10-1-2.png" alt="AC10.2" width="950" />
   </div>
...
```
   ...
   <div align="center">
      <img src="https://i.postimg.cc/jd5jNssW/AC10-1-3.png" alt="AC.3" width="950" />
   </div>
...
```
   ...
   <div align="center">
      <img src="https://i.postimg.cc/nVTzCstb/AC10-1-4.png" alt="AC.4" width="950" />
   </div>

   <div align="center">
      <img src="https://i.postimg.cc/gjMk57Kk/AC10-1-5.png" alt="AC.5" width="700" />
   </div>
...
Este comando generará un informe de cobertura que mostrará el porcentaje de líneas de código cubiertas por las pruebas.
   ...
   <div align="center">
      <img src="https://i.postimg.cc/gkT2HfJg/AC10-1-6.png" alt="AC.6" width="950" />
   </div>
...
Este informe te mostrará las líneas de código faltantes que no han sido cubiertas por las pruebas, permitiéndote enfocarte en aquellas partes del código que necesitan más casos de prueba.
   ...
   <div align="center">
      <img src="https://i.postimg.cc/fLfb7ytd/AC10-1-7.png" alt="AC.7" width="950" />
   </div>
...
```
   ...
   <div align="center">
      <img src="https://i.postimg.cc/d3QV5Frx/AC10-1-8.png" alt="AC.8" width="950" />
   </div>
...
Si por alguna razón los colores no se muestran, puedes forzarlos con la opción `--color=yes`:
   ...
   <div align="center">
      <img src="https://i.postimg.cc/fLNL0mLZ/AC10-1-9.png" alt="AC10.9" width="950" />
   </div>
...
```
   ...
   <div align="center">
      <img src="https://i.postimg.cc/wBJMv090/AC10-1-10.png" alt="AC10.10" width="950" />
   </div>
