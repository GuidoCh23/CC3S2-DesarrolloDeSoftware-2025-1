...
```
   ...
   <div align="center">
      <img src="https://i.postimg.cc/TYJvjcMN/AC11-1-1.png" alt="AC11.1" width="950" />
   </div>
...
```
   ...
   <div align="center">
      <img src="https://i.postimg.cc/NfcwrzVr/AC11-1-2.png" alt="AC11.2" width="430" />
   </div>
...
```
   ...
   <div align="center">
      <img src="https://i.postimg.cc/0j1hDztq/AC11-1-3.png" alt="AC11.3" width="950" />
   </div>
...
```
   ...
   <div align="center">
      <img src="https://i.postimg.cc/52PcTNtw/AC11-1-4.png" alt="AC11.4" width="950" />
   </div>
...
```
   ...
   <div align="center">
      <img src="https://i.postimg.cc/q7zfTVtW/AC11-1-5.png" alt="AC11.5" width="950" />
   </div>
...
Primero hay que instalarlo ejecutando

```
pytest install pytest-random-order
```

   <div align="center">
      <img src="https://i.postimg.cc/wvmS1XQV/AC11-1-6.png" alt="AC10.1" width="950" />
   </div>

Ahora ejecutamos las pruebas en orden aleatorio
...
```
   ...
   <div align="center">
      <img src="https://i.postimg.cc/rpbBynxs/AC11-1-7.png" alt="AC10.1" width="950" />
   </div>
...
```
   ...
   <div align="center">
      <img src="https://i.postimg.cc/XqTqwcRY/AC11-1-8.png" alt="AC11.8" width="950" />
   </div>
...
Si todo está correcto, todas las pruebas deberían pasar y la salida mostrará resultados exitosos.
   ...
   <div align="center">
      <img src="https://i.postimg.cc/XqTqwcRY/AC11-1-8.png" alt="AC11.9" width="950" />
   </div>
...
Esto te mostrará cuántas líneas de código están cubiertas por las pruebas y cuáles no.
   ...
   <div align="center">
      <img src="https://i.postimg.cc/KjK4kssW/AC11-1-9.png" alt="AC11.10" width="950" />
   </div>
